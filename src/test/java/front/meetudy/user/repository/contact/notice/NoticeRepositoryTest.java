package front.meetudy.user.repository.contact.notice;
...
class NoticeRepositoryTest {
    ...
    void notice_detail_prev_none() {
        ...
        assertThrows(CustomApiException.class, () -> {
            noticeRepository.findPrevNoticeNative(notice.getSort())
                    .orElseThrow(() -> new CustomApiException(BAD_REQUEST, ERR_012, ERR_012.getValue()));
        });
    ...
    void notice_detail_next_next() {
        ...
        assertThrows(CustomApiException.class, () -> {
            noticeRepository.findNextNoticeNative(notice.getSort())
                    .orElseThrow(() -> new CustomApiException(BAD_REQUEST, ERR_012, ERR_012.getValue()));
        });
