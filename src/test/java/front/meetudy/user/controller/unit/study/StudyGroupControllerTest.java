package front.meetudy.user.controller.unit.study;
...
class StudyGroupControllerTest {
    ...
    void setUp() {
        ...
        studyGroupDetail = StudyGroupDetail.createStudyGroupDetail(studyGroup, null, Content.required("asdf"), LocalDate.now().minusDays(3), LocalDate.now().plusDays(3), "매주", "월",
        ...
        studyGroupDetail2 = StudyGroupDetail.createStudyGroupDetail(studyGroup2, null, Content.required("asdf"), LocalDate.now().minusDays(3), LocalDate.now().plusDays(3), "매주", "월",
