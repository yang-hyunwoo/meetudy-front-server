package front.meetudy.user.service.integration.study;
...
import front.meetudy.user.repository.study.StudyGroupRepository;
import front.meetudy.user.service.attendance.AttendanceService;
...
class StudyGroupServiceTest {
    ...
    void setUp() {
        ...
        studyGroupDetail = StudyGroupDetail.createStudyGroupDetail(studyGroup, null, Content.required("asdf"), LocalDate.now().minusDays(3), LocalDate.now().plusDays(3), "매주", "월,화,수,목,금,토,일",
