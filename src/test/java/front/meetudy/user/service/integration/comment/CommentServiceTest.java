package front.meetudy.user.service.integration.comment;
...
import front.meetudy.user.service.comment.CommentService;
...
class CommentServiceTest {
    ...
    void comment_update() {
        // given
        Comment comments = Comment.createComments(member, "freeboard", 2L, Content.required("댓글2"), false);
        em.persist(comments);
