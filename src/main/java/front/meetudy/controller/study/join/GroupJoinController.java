...
public class GroupJoinController {
    ...
    public ResponseEntity<Response<List<GroupOperateMemberResDto>>> studyGroupMemberList(
        ...
        return Response.ok("참여 중인 스터디 그룹 멤버 리스트 조회 완료", studyGroupService.studyGroupMemberList(studyGroupId, member));
    }
    ...
    public ResponseEntity<Response<StudyGroupAttendanceRateResDto>> studyGroupMemberRate(
        ...
        return Response.ok("참여 중인 스터디 그룹 멤버 출석률 조회 완료", studyGroupService.memberAttendanceRateList(studyGroupId, member));
    }

    @Operation(summary = "참여 중인 스터디 그룹 탈퇴" , description = "참여 중인 스터디 그룹 탈퇴")
    @PutMapping("/member/{id}/withdraw")
    public ResponseEntity<Response<Void>> studyGroupWithdrwa(
        @PathVariable("id") Long studyGroupId,
        @CurrentMember Member member
    ){
    ...
    public ResponseEntity<Response<List<GroupOperateResDto>>> groupPending(
        ...
        return Response.ok("승인 대기 중인 스터디 그룹 리스트 조회 완료", studyGroupService.groupPendingJoinList(member));
    }
}
